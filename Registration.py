...
image2 =image2.resize((1600,1200), Image.ANTIALIAS)
...
frame = tk.LabelFrame(window, text="", width=600, height=570, bd=5, font=('times', 14, ' bold '),bg="#FADBD8")
frame.grid(row=0, column=0, sticky='nw')
frame.place(x=500, y=140)

lbl = tk.Label(window, text="Registration Form", font=('times', 35,' bold '), height=2, width=60,bg="skyblue",fg="red")
lbl.place(x=0, y=0)
