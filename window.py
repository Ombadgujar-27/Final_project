...
lbl = tk.Label(frame_alpr, text="Fake Review", font=('Times New Roman', 30,' bold '),bg="white",fg="black")
lbl.place(x=300, y=180)

lbl = tk.Label(frame_alpr, text="Detection", font=('Times New Roman', 30,' bold '),bg="white",fg="black")
lbl.place(x=320, y=250)

logo_label=tk.Label()
logo_label.place(x=90,y=55)


logo_label1=tk.Label(text='...To develop a system that capable \n To Detect Fake Review And \n Identify the type of Fake Review...',compound='bottom',font=("Times New Roman", 20, 'bold', 'italic'),width=35, bg="white", fg="black")
